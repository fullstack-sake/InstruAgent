...
class OpenAIEmbeddings(BaseModel, Embeddings):
    ...
    environment variable ``key`` set with your API key or pass it
    ...
    Example:
        .. code-block:: python
            ...
            from core import OpenAIEmbeddings
    ...
    def _tokenize(
        ...
        tokens = []
        indices = []
        mod = self.tiktoken_mod or self.model
        ...
        if not self.tiktoken_enabled:
            ...
            try:
                encoding = tiktoken.encoding_for_model(mod)
            except KeyError:
